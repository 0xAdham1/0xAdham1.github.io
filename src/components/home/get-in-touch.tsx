    ...
    >
      <div className='relative size-64 max-md:mx-auto' ref={scope}>
        ...
        <div id='pointer' className='absolute'>
          ...
          <span className='relative left-4 rounded-4xl bg-red-500 px-2 py-0.5 text-xs text-white'>0xAdham</span>
        </div>
      </div>
      ...
      <div className='flex flex-col justify-center px-4'>
        ...
        <div className='my-8'>
          <a href={`mailto:${SITE_EMAIL}`} className={cn(buttonVariants(), 'bg-email-button text-white')}>
            {SITE_EMAIL}
          </a>
        </div>
      </div>
